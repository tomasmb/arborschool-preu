/**
 * SVG icon components used across diagnostic screens.
 * Each icon accepts a className string for sizing and color.
 */
...
/** Maps each axis abbreviation to its icon renderer */
