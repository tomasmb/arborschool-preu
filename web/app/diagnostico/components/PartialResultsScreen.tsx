    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-lg mx-auto px-4 py-8 sm:py-12">
          ...
          {/* Teaser Card - "one last step" framing */}
          <div
          ...
          >
            <div className="text-center">
              {/* Map icon — framing as destination, not lock */}
              ...
              <h3 className="text-lg font-semibold text-charcoal mb-3">
                Una última pregunta para personalizar tu plan
              </h3>

              {/* What they get — benefit framed */}
              <div className="text-left text-sm text-cool-gray space-y-2.5 mb-4">
                <div className="flex items-start gap-2">
                  <CheckIcon />
                  <span>Tu ruta de estudio personalizada, tema por tema</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckIcon />
                  <span>
                    Revisión detallada de cada pregunta del diagnóstico
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckIcon />
                  <span>Cuántos puntos puedes ganar y en cuánto tiempo</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            Menos de 30 segundos · Sin tarjeta de crédito
          </p>
