...
1. The diagnostic was _designed_ to sample high-value atoms with deep prerequisite chains
...
5. Improvements must be _provable_ through specific atom learning
