...
ALTER TABLE "student_responses" ADD COLUMN "stage" integer DEFAULT 1;--> statement-breakpoint
ALTER TABLE "student_responses" ADD COLUMN "question_index" integer;--> statement-breakpoint
CREATE INDEX "idx_student_responses_attempt" ON "student_responses" USING btree ("test_attempt_id");